function [delesys,estimate,var_sample,temp_quantile_TIME,temp_dele_TIME] = dele_system(index,obser,k,r,delta,p,b,quantile_TIME,dele_TIME)
...
timer2=tic;
    for i = 1:k
        ...
        var_sample(i) = asym_var(obser(i,:),b,r,p);
    end

function [delesys,estimate,estimate_bw,var_sample,psi_all_stage,temp_quantile_TIME,temp_dele_TIME] = dele_system_IS(index,obser,allobser,k,r,delta,p,b,w,quantile_initial,ak,stage,psi_all_previous,n0,C,alpha,quantile_TIME,dele_TIME)
